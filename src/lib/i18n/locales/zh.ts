...
export const zh: Translations = {
  ...
  chart: {
    ...
    cacheMissExplorerTitle: "缓存未命中会话明细",
    cacheMissExplorerDesc: "当前范围内未命中缓存最多的会话（按相邻请求对统计）",
    clickPointHint: "点击数据点查看当天会话",
    ...
    collapse: "收起",
    noContent: "无内容",
    noCacheProvider: "不缓存（provider 不支持）",
    loadingSessions: "加载会话中…",
    columnSession: "会话",
    columnModel: "Provider / 模型",
    columnMissTokens: "未命中 Tokens",
    columnExpected: "期望 Tokens",
    columnMissRate: "未命中率",
    columnPairs: "相邻对",
    columnGap: "间隔",
    columnOutputReasoning: "输出+推理",
    columnTotal: "total",
    columnTime: "时间",
    lifecycleChart: "缓存生命周期（虚线=上一条 total，实线=本条 cache_read）",
    msgIndex: "消息序号",
    heatmapTitle: "活跃度热力图",
