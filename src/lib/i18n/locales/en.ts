...
export const en: Translations = {
  ...
  chart: {
    ...
    cacheMissExplorerTitle: "Cache Miss Sessions",
    cacheMissExplorerDesc: "Sessions with the most missed cache tokens in the current range (by consecutive request pairs)",
    clickPointHint: "Click a point to view that day's sessions",
    ...
    noCacheProvider: "No caching (provider unsupported)",
    loadingSessions: "Loading sessions…",
    columnSession: "Session",
    columnModel: "Provider / Model",
    columnMissTokens: "Missed Tokens",
    columnExpected: "Expected Tokens",
    columnMissRate: "Miss Rate",
    columnPairs: "Pairs",
    columnGap: "Gap",
    columnOutputReasoning: "Output+Reasoning",
    columnTotal: "total",
    columnTime: "Time",
    lifecycleChart: "Cache lifecycle (dashed = prev total, solid = cache_read)",
